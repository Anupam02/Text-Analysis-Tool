...
<legend style="font-size:40px;color:blue">Text :</legend>
<p style="font-size:30px">
To make a text analysis, you can use the free tool, textalyser.net
From Wikipedia, the free encyclopedia.
In language, text is something that contains words to express something. The term usually has broader meaning. In linguistics text enters at least two types of contrasts. One is that between system and text, system being understood as the ability of the speakers to communicate using verbal signs, and text being understood as the product of this ability. 
