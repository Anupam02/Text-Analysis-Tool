# -*- coding: utf-8 -*-
"""
Created on Sat Dec 13 10:43:45 2014
...
def main():
    ...
    largest_sentence_len_res  =  largest_sentence_len(test_data,min_char_per_word,special_word,stop_list)
    print largest_sentence_len_res
    
def largest_sentence_len(test_data,min_no_chars,spec_words,stop_list):
