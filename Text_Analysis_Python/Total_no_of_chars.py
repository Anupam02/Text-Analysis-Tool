# -*- coding: utf-8 -*-
"""
Created on Sat Dec 13 00:16:26 2014
...
def main():
    ...
    total_no_of_chars_res            = total_no_of_chars(test_data,min_char_per_word,special_word,stop_list)
    print total_no_of_chars_res
    
def total_no_of_chars(test_data,min_no_chars,spec_words,stop_list):
    """Counts the total number of characters without any constraints in test data"""
