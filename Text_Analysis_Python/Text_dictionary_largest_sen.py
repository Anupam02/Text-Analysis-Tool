# -*- coding: utf-8 -*-
"""
Created on Sat Dec 13 11:23:47 2014
...
def main():
    ...
    largest_sentence_res  =  largest_sentence(test_data,min_char_per_word,special_word,stop_list)
    print largest_sentence_res
    
def largest_sentence(test_data,min_no_chars,spec_words,stop_list):
